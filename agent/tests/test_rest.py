...
class InfoJsonBuilderTest(TestCase):
    ...
    def test_all(self):
        ...
        b.add_name('name1')
        b.add_mac([('ethernet', '00:5a:b6:6a:bz:8f'), ('wifi', '00:5a:b6:6a:bz:8f')])
        ...
        expected = json.dumps({
            'name': 'name1',
            'macAddresses': [{'interfaceName': 'ethernet', 'mac': '00:5a:b6:6a:bz:8f'},
                             {'interfaceName': 'wifi', 'mac': '00:5a:b6:6a:bz:8f'}],
            'temperature': 65.12,
